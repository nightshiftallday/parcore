...
constexpr const uint64_t PAGE_DECODER_NUM_REGS = 4;
...
public:
   ...
   */
  void process_page(metadata::Compression compression, PageType page_type,
   ...
   *                     PageDecoder.
   */
  void process_chunk(metadata::ColumnChunk &column_chunk);
