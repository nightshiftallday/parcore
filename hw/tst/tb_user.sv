...
module tb_user;
    ...
    initial begin
    axi_ctrl_drv.write(4, 64'h0000000000004000);
    // axi_ctrl_drv.write(4, 64'h0000000000004020);
    // axi_ctrl_drv.write(4, 64'h0000000000004000);
    // axi_ctrl_drv.write(4, 64'h0000000000004020);
    // axi_ctrl_drv.write(4, 64'h00000000002f4000);
    // axi_ctrl_drv.write(4, 64'h00000000002f4000);
    // axi_ctrl_drv.write(4, 64'h0000000000104004);
    // axi_ctrl_drv.write(4, 64'h00000000002d4801);

    axi_ctrl_drv.write(4, 64'h0000000000004000);
    axi_ctrl_drv.write(4, 64'h0000000000004004);
    axi_ctrl_drv.write(4, 64'h0000000000204800);
    axi_ctrl_drv.write(4, 64'h0000000000204801);
    axi_ctrl_drv.write(4, 64'h0000000000004000);

    axi_ctrl_drv.write(4, 64'h0000000000801300);
    axi_ctrl_drv.write(4, 64'h0000000000004000);
    // axi_ctrl_drv.write(4, 64'h0000000000008004);
    // axi_ctrl_drv.write(4, 64'h0000000000008801);
    // axi_ctrl_drv.write(4, 64'h0000000000008000);
    end
